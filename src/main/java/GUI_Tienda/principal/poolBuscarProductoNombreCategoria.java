 ...
 * @author fell
 */
public class poolBuscarProductoNombreCategoria implements Callable<String>,ActionListener {
    ...
    public poolBuscarProductoNombreCategoria(ControladorTiendaPrincipal controladorProductos) {
    ...
    public void mostrarHorarios(){
        ...
        String categoriaBuscar=controladorProductos.getGestionarTiendaPrincipal().categorias.getSelectedItem().toString();
        System.out.println("SSSSSSSSSSSSSSSSS"+categoriaBuscar);
        ArrayList<Producto> productosBuscados=productoBuscado.buscarProductosNombreCategoria(nombreBuscar,categoriaBuscar);
        ...
        for(Producto pa: productosBuscados){
            ...
            contador++;
            panelProductosTienda.productosSub.add(c,0);
            panelProductosTienda.productosSub.updateUI();
        }
        controladorProductos.setPanelControladorProducto(panelProductosTienda,  new Dimension(516, 420));       
