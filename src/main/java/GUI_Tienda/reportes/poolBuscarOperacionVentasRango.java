 ...
 * @author fell
 */
public class poolBuscarOperacionVentasRango implements Callable<String>,ActionListener {
    ...
    public poolBuscarOperacionVentasRango(ControladorTiendaReportes controladorTiendaCaja) {
    ...
    public void mostrarHorarios(){
        ...
        Date fecha=new Date();
        Date fecha1=new Date(fecha.getTime() + (1000 * 60 * 60 * 24));
        ArrayList<Venta> productosOperaciones=operacionesCaja.buscarVentasRango(fecha,fecha1);
