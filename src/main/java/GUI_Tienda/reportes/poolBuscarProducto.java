 ...
 * @author fell
 */
public class poolBuscarProducto implements Callable<String>,ActionListener {
    ...
    public poolBuscarProducto(ControladorTiendaReportes controladorProductos) {
    ...
    public void mostrarHorarios(){
        ...
        for(Producto pa: productosBuscados){
            ...
            ProductoBuscadosVendido c=new ProductoBuscadosVendido(pa.getCantidadMinima()>pa.getCantidad());   
