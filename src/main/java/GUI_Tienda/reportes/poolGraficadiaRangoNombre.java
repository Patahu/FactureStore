 ...
 * @author fell
 */
public class poolGraficadiaRangoNombre implements Callable<String>,ActionListener {
    ...
    public poolGraficadiaRangoNombre(ControladorTiendaReportes controladorTiendaCaja) {
    ...
    public void mostrarHorarios(){
        ...
        ArrayList<ProductoVendido> productosOperaciones=operacionVentas.buscardiaRangoNombre(fecha1,fecha2,nombreBuscar);
