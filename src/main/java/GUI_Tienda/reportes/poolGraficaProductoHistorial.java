 ...
 * @author fell
 */
public class poolGraficaProductoHistorial implements Callable<String>,ActionListener {
    ...
    public poolGraficaProductoHistorial(ControladorTiendaReportes controladorTiendaCaja) {
    ...
    public void mostrarHorarios(){
        ...
        ArrayList<ProductoVendido> productosOperaciones=operacionVentas.buscarHistorialProductoTodo();
