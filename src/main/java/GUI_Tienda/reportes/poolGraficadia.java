 ...
 * @author fell
 */
public class poolGraficadia implements Callable<String>,ActionListener {
    ...
    public poolGraficadia(ControladorTiendaReportes controladorTiendaCaja) {
    ...
    public void mostrarHorarios(){
        ...
        ArrayList<ProductoVendido> productosOperaciones=operacionVentas.buscardia();
