 ...
 * @author fell
 */
public class poolGraficadiaNombreVentas implements Callable<String>,ActionListener {
    ...
    public poolGraficadiaNombreVentas(ControladorTiendaReportes controladorTiendaCaja) {
    ...
    public void mostrarHorarios(){
        ...
        ArrayList<ProductoVendido> productosOperaciones=operacionVentas.buscardiaNombreVentas(nombreBuscar);
