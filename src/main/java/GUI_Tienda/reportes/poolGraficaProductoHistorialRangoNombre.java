 ...
 * @author fell
 */
public class poolGraficaProductoHistorialRangoNombre implements Callable<String>,ActionListener {
    ...
    public poolGraficaProductoHistorialRangoNombre(ControladorTiendaReportes controladorTiendaCaja) {
    ...
    public void mostrarHorarios(){
        ...
        ArrayList<ProductoVendido> productosOperaciones=operacionVentas.buscarHistorialProductoRangoNombre(fecha1,fecha2,nombreBuscar);
