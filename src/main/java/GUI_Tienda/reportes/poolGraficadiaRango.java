 ...
 * @author fell
 */
public class poolGraficadiaRango implements Callable<String>,ActionListener {
    ...
    public poolGraficadiaRango(ControladorTiendaReportes controladorTiendaCaja) {
    ...
    public void mostrarHorarios(){
        ...
        ArrayList<ProductoVendido> productosOperaciones=operacionVentas.buscardiaRango(fecha1,fecha2);
        ...
        //.getGestionarTiendaCaja().totalPrecio.setText(""+total);
