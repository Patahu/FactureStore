 ...
 * @author fell
 */
public class poolGraficaProductoHistorialSoloNombre implements Callable<String>,ActionListener {
    ...
    public poolGraficaProductoHistorialSoloNombre(ControladorTiendaReportes controladorTiendaCaja) {
    ...
    public void mostrarHorarios(){
        ...
        ArrayList<ProductoVendido> productosOperaciones=operacionVentas.buscarHistorialProductoSoloNombre(nombreBuscar);
