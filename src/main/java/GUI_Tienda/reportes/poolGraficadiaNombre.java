 ...
 * @author fell
 */
public class poolGraficadiaNombre implements Callable<String>,ActionListener {
    ...
    public poolGraficadiaNombre(ControladorTiendaReportes controladorTiendaCaja) {
    ...
    public void mostrarHorarios(){
        ...
        ArrayList<ProductoVendido> productosOperaciones=operacionVentas.buscardiaNombre(nombreBuscar);
