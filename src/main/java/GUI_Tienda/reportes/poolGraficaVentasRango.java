 ...
 * @author fell
 */
public class poolGraficaVentasRango implements Callable<String>,ActionListener {
    ...
    public poolGraficaVentasRango(ControladorTiendaReportes controladorTiendaCaja) {
    ...
    public void mostrarHorarios(){
        ...
        ArrayList<ProductoVendido> productosOperaciones=operacionVentas.buscarProductoxrango(fecha1,fecha2);
        ...
        controladorTiendaCaja.setPanelControladorProducto(panel,  new Dimension(1180, 474)); 
    }
    @Override
