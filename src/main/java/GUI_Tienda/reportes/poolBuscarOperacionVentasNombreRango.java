 ...
 * @author fell
 */
public class poolBuscarOperacionVentasNombreRango implements Callable<String>,ActionListener {
    ...
    public poolBuscarOperacionVentasNombreRango(ControladorTiendaReportes controladorTiendaCaja) {
    ...
    public void mostrarHorarios(){
        ...
        Date fecha=controladorTiendaCaja.getGestionarTiendaCaja().calendarioPrimero.getDate();
        Date fecha1=controladorTiendaCaja.getGestionarTiendaCaja().calendarioFinal.getDate();
        ArrayList<Venta> productosOperaciones=operacionesCaja.buscarVentasNombreRango(nombreBuscar,fecha,fecha1);
