 ...
 * @author fell
 */
public class poolBuscarGestionarProducto implements Callable<String>,ActionListener {
    ...
    public poolBuscarGestionarProducto(ControladorProducto controladorProductos) {
    ...
    public void mostrarHorarios(){
        ...
        PanelProductosTienda panelProductosTienda= new PanelProductosTienda();
        int contador=0;
